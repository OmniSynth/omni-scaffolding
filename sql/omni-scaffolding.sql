...
INSERT INTO `sys_config` VALUES (6, 'sys.security.session-limit.enabled', '并发登录限制开关', 'true', '是否限制同账号同时在线设备数；true 开启，false 关闭。关闭或 max-devices≤0 时不限制', 5, 1, 1, 0, '2026-07-24 17:00:00.000', '2026-07-24 17:00:00.000', 0);
INSERT INTO `sys_config` VALUES (7, 'sys.security.session-limit.max-devices', '最大同时在线设备数', '3', '每用户最大同时在线设备数；超限踢最旧会话。整数，≤0 表示不限制', 6, 1, 1, 0, '2026-07-24 17:00:00.000', '2026-07-24 17:00:00.000', 0);
